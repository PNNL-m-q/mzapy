...
.. note::
    ...
    When creating a branch to implement a bugfix, new feature, or add documentaion, append ".<your_github_username>" 
    to the current ``__version__`` variable in ``mzapy/__init__.py``
